...
public class hazakBass : MonoBehaviour
{
    ...
    void onSpectrum(float[] spectrum)
    {
        ...
        else { transform.localScale = new Vector3(1f, Size + Mathf.Abs(spectrum[2] * zenemeretes), 1f); }*/
        for (int i = 0; i < 10; i++){
            Houses[i].transform.localScale = new Vector3(Size, Size, Size + Mathf.Abs(spectrum[i] * zenemeretes));
        }
    }
}
